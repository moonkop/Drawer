...
namespace WindowsFormsApplication1
{
    public partial class roll5 : Form
    {
        ...
        public roll5(Form1 obj1, int nums, Student.selectedType st)
        {
            InitializeComponent();
            obj = obj1;
            rollnum = nums;
        ...
        void showdata(Student std, int pointer)
        {
            try
            {
                ...
                pb[pointer].Load(Form1.PicPath + std.ID + ".jpg");
            }
            catch (Exception)
            { }
        }
        ...
        {
            int i;
            int rNumsForEachLine = int.Parse(Assistance.GetConfigurations(Form1.ConfigPath, "rNumsForEachLine"));
            timer1.Interval = int.Parse(Assistance.GetConfigurations(Form1.ConfigPath, "bigTimerInterval"));
            int rWidthForEach = int.Parse(Assistance.GetConfigurations(Form1.ConfigPath, "rWidthForEach"));
            int rXBlankspace = int.Parse(Assistance.GetConfigurations(Form1.ConfigPath, "rXBlankspace"));
            int rTextboxheight = int.Parse(Assistance.GetConfigurations(Form1.ConfigPath, "rTextboxheight"));
            int rPictureboxHeight = int.Parse(Assistance.GetConfigurations(Form1.ConfigPath, "rPictureboxHeight"));
            int rCommandHeight = int.Parse(Assistance.GetConfigurations(Form1.ConfigPath, "rCommandHeight"));
            int yTextboxBlankSpace = int.Parse(Assistance.GetConfigurations(Form1.ConfigPath, "yTextboxBlankSpace"));
            bool autoSizeEnabled = Convert.ToBoolean(Assistance.GetConfigurations(Form1.ConfigPath, "autoSizeEnabled"));
            bool autoNumsForEachLine = Convert.ToBoolean(Assistance.GetConfigurations(Form1.ConfigPath, "autoNumsForEachLine"));
